...
public class InventorArtefactUpdateTest extends TestHarness {
	...
	public void hackingTest() {
		...
		//HINT+ a) try to update an artefact as a patron 
		
		//HINT+ b) try to update an artefact of another inventor as an inventor
		
		//HINT+ a) try to update an artefact as an anonymous principal 
		
		//HINT+ b) try to update an artefact of another inventor as an administrator
	}
