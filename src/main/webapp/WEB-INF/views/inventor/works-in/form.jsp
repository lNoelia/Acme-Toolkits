...
<acme:form>
	<jstl:choose>
		...
		<jstl:when test="${acme:anyOf(command, 'show, update, delete')}">
			...
			<acme:input-textbox code="inventor.worksin.form.label.amount" path="amount" readonly="${readonly}"/>
			...
			<acme:input-textbox code="inventor.worksin.form.label.price" path="artefact.retailPrice" readonly="true"/>
		...
		<jstl:when test="${command == 'create'}">
			...
			<acme:input-textbox code="inventor.worksin.form.label.amount" path="amount" readonly="false"/>
