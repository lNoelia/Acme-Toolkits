...
<acme:footer-panel>
	...
	<acme:footer-subpanel code="master.footer.title.social">
		<acme:message var="githubUrl" code="master.footer.url.github"/>
		<acme:footer-option icon="fab fa-github" code="master.footer.label.github" action="${githubUrl}" newTab="true"/>
	</acme:footer-subpanel>
